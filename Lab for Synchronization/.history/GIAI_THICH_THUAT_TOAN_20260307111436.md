...
**Cách cấu hình chương trình:**

Chỉnh tham số trong file `bounded_buffer_input.txt`:
```
<run_seconds> <số_producer> <số_consumer> <start_number>
```
Ví dụ nội dung file:
```
10 2 2 0
```
Tương ứng: chạy **10 giây**, **2 producer**, **2 consumer**, số bắt đầu từ **0**.
