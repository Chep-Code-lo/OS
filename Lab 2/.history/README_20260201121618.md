...
- ✅ Chậm hơn UDP
- ✅ Dùng cho: Chat, file transfer, web

**UDP (User Datagram Protocol):**
- ✅ Không cần kết nối (connectionless)
- ✅ Không đảm bảo dữ liệu đến
- ✅ Nhanh hơn TCP
- ✅ Dùng cho: Streaming, game online

### Các khái niệm JavaScript

**1. Callback:** Hàm được truyền như tham số, gọi sau
```javascript
rl.question('Nhập: ', (answer) => {
    cb(answer);  // Gọi callback
});
```

**2. Arrow Function:** `(param) => { return value }`

**3. Destructuring:** Lấy giá trị từ object/array
```javascript
